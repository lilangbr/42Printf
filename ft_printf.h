...
int				ft_fieldstorage(va_list *p_ap, const char *fmt,int *fmt_inc, t_fields *f);
void			ft_fillflags(const char *fmt, int *fmt_inc, t_fields *f);
void			ft_fillwidth(va_list *p_ap, const char *fmt,int *fmt_inc,t_fields *f);
int				ft_fillprecision(va_list *p_ap, const char *fmt, int *fmt_inc, t_fields *f);
